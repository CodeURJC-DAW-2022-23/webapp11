    ...
    SecurityFilterChain apiSecurityFilterChain(HttpSecurity http) throws Exception
    {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/products/edit/**").hasAnyAuthority("ADMIN")
                        .requestMatchers("/api/checkout").hasAnyAuthority("USER","AGENT")
                        ...
                        .requestMatchers("/api/user/{id}").hasAnyAuthority("AGENT", "ADMIN", "USER")
                        .requestMatchers("/api/user/hassentmessage").hasAnyAuthority("AGENT")
                        ...
                        .requestMatchers("/api/products/remove-from-stock/**").hasAnyAuthority("ADMIN")
