...
export class AuthService {
  ...
  verify(email: string, code: string, password: string, firstName: string, lastName:string): Observable<any> {
    return this.http.post('/api/auth/code', {email, password, firstName, lastName, code});
  }
