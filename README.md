...
## API REST Documentation (Links need to be updated before releasing!)

As we are using SpringBoot 3, we need to use need to use [springdoc-openapi v2.0.4](https://springdoc.org/v2/) to generate the documentation. The documentation is available at `/api-docs` and `/api-docs.yaml` endpoints. We also created a [Postman collection](LINK HERE) to test the API.

We provide a Yaml file with the API documentation, and a html file with the documentation generated by Swagger UI, you can find them on this raw [YAML](https://raw.githubusercontent.com/CodeURJC-DAW-2022-23/webapp11/main/backend/app/src/main/resources/static/api-docs.yaml) and [HTML](https://rawcdn.githack.com/CodeURJC-DAW-2022-23/webapp11/56603d8e277f86885c17805ecf38619d557f1476/backend/app/api-docs/api-docs.html).

You can also access and test the API using the built-in Swagger UI provided as part of the used dependency at `https://localhost:8443/api-docs`, as well as the YAML file at `https://localhost:8443/v3/api-docs.yaml`.
