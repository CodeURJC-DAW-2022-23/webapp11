...
- [Miro](https://miro.com/app/board/uXjVPsgTwzE=/?share_link_id=723285257163)
...
| Reviews | Users adding reviews will be able to upload up to 3 photos of the product, this won't be able to be modified later on.| 
---
...
The other chart will be a bar chart showing the quantities sold each day for the last week.
...
The algorithm used on our web app will be a simple reccomendation algorithm, which will reccomend products to our users while they are browsing our web page, according to different factors like their history, their wishlist, their recent purchases or their cart.